...
# the list of smal animal names that are used for training, which are with
# caption labels.
smal_animal_names_v1_train = [
    "bear3EP",
    "bear84Q",
    "bear9AK",
    "bearPDD",
...
# with open('./deforming_things_4d/deforming_things_4d_stats.json', 'r', encoding='utf-8') as f:
#     stats = json.load(f)
